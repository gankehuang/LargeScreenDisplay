        ...
        <el-dropdown>
          <span
            ...
            style="
              ...
              border-radius: 4px;"
          >
            {{ areaData }}<i class="el-icon-arrow-down el-icon--right" />
          </span>
          <el-dropdown-menu
            slot="dropdown"
            style="width: 96px;"
          >
            <el-dropdown-item
              ...
              :key="index"
              @click.native="areaDataListClick(item)"
            >
              {{ item }}
            </el-dropdown-item>
          </el-dropdown-menu>
        ...
        <el-dropdown>
          <span
            ...
            style="
              ...
              border-radius: 4px;"
          >
            {{ kindData }}<i class="el-icon-arrow-down el-icon--right" />
          </span>
          <el-dropdown-menu
            slot="dropdown"
            style="width: 96px;"
          >
            <el-dropdown-item
              v-for="(item, index) in kindDataList"
              :key="index"
              @click.native="kindClick(item)"
            >
              {{ item }}
...
.center {
  ...
  .info {
    ...
    width: 100%;
    height: 400px;
    background: url('~@/assets/images/interviewAnalysis/interview-bg.png') no-repeat;
    background-size: 100% 100%;
    .echarts {
      width: 100%;
      height: 100%;
