    ...
    <div class="modal">
      ...
      <div class="body">
          ...
          >
            ...
            >
              <img
                ...
                src="@/assets/images/publicMonitor/device.png"
              >
        ...
        <div class="content2 checked">
          ...
          >
            {{ item.name }}
            <img src="@/assets/images/publicMonitor/label-remove.png">
          </div>
        </div>
...
.modal {
  ...
  .body {
    ...
    position: relative;
    .content1 {
      background: url("~@/assets/images/publicMonitor/modal-content1.png") no-repeat;
      width: 354px;
      height: 466px;
    }
    .content2 {
      background: url("~@/assets/images/publicMonitor/modal-content2.png") no-repeat;
      width: 243px;
      height: 225px;
    ...
    .btn {
      ...
      right: 14px;
      button {
        background: url("~@/assets/images/publicMonitor/submit-btn.png");
        width: 104px;
        height: 38px;
        text-align: center;
        line-height: 38px;
