  ...
  <div class="detail-info-container">
    ...
    >
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="涉事单位：">
            <el-input
              v-model="baseInfo.involvedUnitText"
              readonly
            />
          </el-form-item>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="上报人：">
            <el-input
              v-model="baseInfo.peopleName"
              readonly
            />
          </el-form-item>
          <el-form-item label="性别：">
            <el-input
              v-model="reportInfo.sex"
              readonly
            />
          </el-form-item>
          ...
          <el-form-item label="联系电话：">
            <el-input
              v-model="baseInfo.reporterPhone"
              readonly
            />
          </el-form-item>
        ...
        <el-col :span="12">
          ...
          <el-form-item label="来电电话：">
            <el-input
              v-model="reportInfo.telephone"
              readonly
            />
          </el-form-item>
          <el-form-item label="上报时间：">
            <el-input
              v-model="baseInfo.receiveTime"
              readonly
            />
          </el-form-item>
        </el-col>
      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="处理部门：">
            <el-input
              v-model="currentOwnerInfo.unit"
              readonly
            />
          </el-form-item>
          <el-form-item label="联系电话：">
            <el-input
              v-model="currentOwnerInfo.phone"
              readonly
            />
          </el-form-item>
        </el-col>
    ...
    >
      <el-col :span="4">
        <el-avatar
          :size="58"
          :src="require('@/assets/images/common/no-avatar.png')"
        />
      </el-col>
  ...
  data () {
    return {
      ...
      evaluateList: [
        {
          name: '艾*德',
          avatar: require('@/assets/images/common/no-avatar.png'),
